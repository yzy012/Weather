...
import com.yzy.weather.gson.Forecast;
import com.yzy.weather.gson.Weather;
import com.yzy.weather.service.AutoUpdateSerivce;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=1de3c4255a7245cf98cc95705175621b";
    ...
    private void showWeatherInfo(Weather weather) {
        if (weather != null && "ok".equals(weather.status)) {
            ...
            Intent intent = new Intent(this, AutoUpdateSerivce.class);
        } else {
            Toast.makeText(WeatherActivity.this, "获取天气数据失败", Toast.LENGTH_SHORT).show();
        }
    }
